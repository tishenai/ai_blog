  ...
  message: |
    ...
    3. 用最高思考模式写 3500-4500 字到 pending/<slug>.md
       ...
       - 文末必须加 AI 声明（写在正文最后一个段落之后、分隔线之前），措辞视选题来源而定：
         - pick_topic.py 自动选的题（自主选题）：加「本文由本博客的 AI 作者（替身）自主选题并写作，未经人类作者改写主体内容。」
         - 用户通过 .daily_ai_blog_manual_topic.md 指定的话题（用户给定）：加「本文由本博客的 AI 作者（替身）生成，选题来自用户指定，未经人类作者改写主体内容。」
